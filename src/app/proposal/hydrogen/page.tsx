      ...
      <div ref={containerRef} className="ap-container">
        ...
        <section className="ap-slide" ref={s1.ref}>
          ...
          <div className={`ap-title-content ${s1.inView ? "in" : ""}`}>
            ...
            <div className="ap-badge">PROCUREMENT CASE STUDY</div>
            <h1 className="ap-h1">
              <span className="ap-h1-line ap-h1-1">Transformer Sourcing</span>
              <span className="ap-h1-line ap-h1-2">for Hydrogen Infrastructure</span>
            </h1>
            <p className="ap-subtitle">
              How FluxCo sources <strong>40 competitive quotes</strong> in 3 weeks
            </p>
            <div className="ap-title-meta">
              <span><Clock className="w-4 h-4" /> 3-Week Procurement Cycle</span>
              <span><Factory className="w-4 h-4" /> 69+ Global OEMs</span>
            </div>
          </div>
        </section>
        ...
        <section className="ap-slide" ref={s2.ref}>
          ...
          <div className={`ap-content ${s2.inView ? "in" : ""}`}>
            ...
            <h2 className="ap-h2">How We Source for Hydrogen Projects</h2>
            <p className="ap-p">
              Recent procurement for a <strong>20 MVA substation transformer</strong> — the same class of
              equipment electrolyzer sites need for grid interconnection.
            </p>
        ...
        <section className="ap-slide" ref={s3.ref}>
          ...
          <div className={`ap-content ${s3.inView ? "in" : ""}`}>
            ...
            <p className="ap-p">
              40 bids from OEMs worldwide — plotted by <strong>total lead time</strong> and <strong>quoted price</strong>.
              Dot size reflects <strong>quality score</strong> (1-10). Green = recommended. Red line = target delivery.
              The best options cluster in the lower-left: fast delivery, competitive price, high quality.
            </p>
        ...
        <section className="ap-slide" ref={s9.ref}>
          ...
          <div className={`ap-closing ${s9.inView ? "in" : ""}`}>
            ...
            <h2 className="ap-closing-h2">Your Hydrogen Project Deserves This</h2>
            <p className="ap-closing-p">
              You&apos;re building hydrogen plants, not becoming transformer procurement experts.
              Let FluxCo source 40+ competitive quotes for your next site in under 3 weeks.
            </p>
            <p className="ap-closing-p" style={{ fontSize: "0.85em", opacity: 0.7, marginTop: "-8px" }}>
              Spec once. Source everywhere. FEOC compliant. K-factor rated for electrolyzer loads.
            </p>
            <a href="mailto:brian@fluxco.com?subject=Hydrogen%20project%20—%20transformer%20sourcing" className="ap-cta">
              Let&apos;s Talk <ArrowRight className="w-4 h-4" />
            </a>
            <div className="ap-closing-contact">
              <span>Brian Tochman &mdash; FluxCo</span>
              <span style={{ fontSize: "0.8em", opacity: 0.5 }}>brian@fluxco.com &middot; 214-578-6083 &middot; fluxco.com</span>
            </div>
          </div>
        </section>
